  ...
  return (
    <View style={searchBar.searchBarContainer}>
      <View style={searchBar.searchIconContainer}>
        ...
        <Image source={require('./src/assets/images/iconSearch.png')} style={searchBar.searchIcon} />
      </View>
      <TextInput
  ...
  return (
    <View style={footer.footerContainer}>
      <View style={footer.footerItem}>
        <Image style={footer.image} source={require('./src/assets/images/iconHouse.png')} />
      </View>
      <View style={footer.footerItem}>
        <Image style={footer.image} source={require('./src/assets/images/iconLike.png')} />
      </View>
      <View style={footer.footerItem}>
        <Image style={footer.image} source={require('./src/assets/images/iconAdd.png')} />
      </View>
      <View style={footer.footerItem}>
        <Image style={footer.image} source={require('./src/assets/images/iconSchedule.png')} />
      </View>
      <View style={footer.footerItem}>
        <Image style={footer.image} source={require('./src/assets/images/iconProfile.png')} />
      </View>
    </View>
  );
}
